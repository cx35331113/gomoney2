...
import com.cloud.oauth.gomoney.security.utils.OAuth2ErrorCodesExpand;
import com.cloud.oauth.gomoney.security.utils.ScopeException;
...
public abstract class OAuth2ResourceBaseAuthenticationProider <T extends OAuth2ResourceBaseAuthenticationToken>
        implements AuthenticationProvider, InitializingBean, MessageSourceAware {

    private static final Logger LOGGER = LogManager.getLogger(OAuth2ResourceBaseAuthenticationProider.class);
    ...
    //private CustomeOAuth2RefreshTokenGenerator refreshTokenGenerator;
     ...
     * @since 0.2.3
     */
    public OAuth2ResourceBaseAuthenticationProider(AuthenticationManager authenticationManager,
    ...
    /*@Deprecated
    public void setRefreshTokenGenerator(CustomeOAuth2RefreshTokenGenerator  refreshTokenGenerator) {
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        try {
            ...
            DefaultOAuth2TokenContext.Builder tokenContextBuilder = DefaultOAuth2TokenContext.builder()
                    ...
                    .authorizationGrantType(resouceOwnerBaseAuthentication.authorizationGrantType)
