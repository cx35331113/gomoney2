...
package com.cloud.oauth.gomoney.feign.sentinel.ext;
 ...
 * @date 2020/6/9
 */
public final class GomoneySentinelFeign {

    private GomoneySentinelFeign() {

    }

    public static GomoneySentinelFeign.Builder builder() {
        return new GomoneySentinelFeign.Builder();
    }
    ...
    public static final class Builder extends Feign.Builder implements ApplicationContextAware {
        ...
        @Override
        public GomoneySentinelFeign.Builder contract(Contract contract) {
            ...
            super.invocationHandlerFactory(new InvocationHandlerFactory() {
                ...
                public InvocationHandler create(Target target, Map<Method, MethodHandler> dispatch) {
                    ...
                    if (void.class != fallback) {
                        ...
                        return new GomoneySentinelInvocationHandler(target, dispatch,
                    ...
                    if (void.class != fallbackFactory) {
                        ...
                        return new GomoneySentinelInvocationHandler(target, dispatch, fallbackFactoryInstance);
                    }
                    return new GomoneySentinelInvocationHandler(target, dispatch);
                }
