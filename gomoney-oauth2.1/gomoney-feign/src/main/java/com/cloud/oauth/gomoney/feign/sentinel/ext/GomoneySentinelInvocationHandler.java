 ...
 */
@Slf4j
public class GomoneySentinelInvocationHandler implements InvocationHandler {
	...
	GomoneySentinelInvocationHandler(Target<?> target, Map<Method, InvocationHandlerFactory.MethodHandler> dispatch,
	...
	public boolean equals(Object obj) {
		if (obj instanceof SentinelInvocationHandler) {
			GomoneySentinelInvocationHandler other = (GomoneySentinelInvocationHandler) obj;
